...
while($shipper_array = mysqli_fetch_row($shipper_query))
{
    ...
    foreach ($shipper_array as $user_detail)
    {
        ...
        {           
            ...
            {
                echo ''    
                . '<form class="form-inline" method="post" action="ban_shipper.php?email='.$shipper_array[4].'" '
            ...
            {
                echo ''    
                . '<form class="form-inline" method="post" action="remove_ban_shipper.php?email='.$shipper_array[4].'&&head=v" '
                        . 'style="margin-left: 50%">'            
                . '<button type="submit" class="btn btn-default"
