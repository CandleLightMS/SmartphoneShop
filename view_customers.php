...
$cust_query = mysqli_query($conn, "SELECT * FROM customer");
...
while($cust_array = mysqli_fetch_row($cust_query))
{
    $counter++;
    ...
    foreach ($cust_array as $user_detail)
    {
        print ("<b>");
    
        $isBanned = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM banned_users WHERE login_id = '$cust_array[5]'"));
        ...
        {           
            ...
            {
                echo ''    
                . '<form class="form-inline" method="post" action="ban_user.php?login_id='.$cust_array[5].'" '
            ...
            {
                echo ''    
                . '<form class="form-inline" method="post" action="remove_ban_user.php?login_id='.$cust_array[5].'" '
                        . 'style="margin-left: 50%">'            
                . '<button type="submit" class="btn btn-default"
