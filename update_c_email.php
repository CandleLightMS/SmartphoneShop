...
$email_query = mysqli_query($conn, "SELECT u_email FROM customer WHERE login_id = '$user_id'");
...
if(isset($_POST['submitbtn']))
{
    ...
    $slquery = "SELECT * FROM customer WHERE u_email = '$e'";
    ...
    if($flag==0)
    {
        mysqli_query($conn, "UPDATE customer SET u_email = '$e' WHERE login_id = '$user_id'");
