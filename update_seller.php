...
<html>
    ...
    <div class="row">
        ...
        <div class="col-md-5" style="margin-left: 2%">
            <form role="form" method="post" action="update_sname.php">
            <button type="submit" class="btn btn-block btn-info"
                    style="background-color: white; color: black; border-color: black; font-size: 18px; font-family: sans-serif">
            Update Name</button>
            </form>
    ...
    <div class="row">
        ...
        <div class="col-md-5" style="margin-left: 2%">
            <form role="form" method="post" action="update_s_email.php">
            <button type="submit" class="btn btn-block btn-info"
                    style="background-color: white; color: black; border-color: black; font-size: 18px; font-family: sans-serif">
    ...
    <div class="row">
        ...
        <div class="col-md-5" style="margin-left: 2%">
            <form role="form" method="post" action="deleteaccount.php">
            <button type="submit" class="btn btn-block btn-info btn-primary" 
                style="background-color: lightgray; color: black; border-color: black; font-size: 18px; font-family: sans-serif">
